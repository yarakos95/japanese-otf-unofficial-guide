...
\subsection{\texorpdfstring{\opt{multi}}{multi}オプション}
...
他方で、\cmd{CID}のバリエーションコマンドに入力するCID値は、それぞれのスクリプトのものに依存します。そのため、{\fantizi}は``{\ptmfamily Adobe-CNS1-7}''、{\jiantizi}は``{\ptmfamily Adobe-GB1-5}''、{\hankgo}は``{\ptmfamily Adobe-Korean1-2}'' \sidenote{{\hankgo}のROSにはAdobe-KR-9もあります。このROSは最終更新が1998年のAdobe-Korean1-2よりも新しいROSですが、\pkg*{japanese-otf}ではAdobe-Korean1-2であることに注意してください。}
です。
